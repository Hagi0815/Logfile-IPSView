...
';
		...
		return '<!DOCTYPE html><html lang="de"><head><meta charset="utf-8">' . $refreshMeta . '<style>' . $css . $cssVar . '</style></head><body>'
			...
			.   '<span style="width:1px;background:#333;align-self:stretch;margin:0 2px"></span>'
			.   '<a class="btn" href="' . $h . '?a=ExportPdf&amp;scope=seite" target="_blank" title="PDF Seite">&#128196;</a>'
			.   '<a class="btn" href="' . $h . '?a=ExportPdf&amp;scope=alle" target="_blank" title="PDF Alle">&#128196;*</a>'
			.   '<a class="btn" href="' . $h . '?a=ExportCsv&amp;scope=seite" title="CSV Seite">&#128190;</a>'
			.   '<a class="btn" href="' . $h . '?a=ExportCsv&amp;scope=alle" title="CSV Alle">&#128190;*</a>'
